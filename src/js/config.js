...
// FONT embed helper (for exports) — nạp font local; woff2 trong fonts.css là đường dẫn
// tương đối nên khi @import vào iframe xuất, trình duyệt vẫn phân giải đúng.
const FONT_EMBED = `@import url('${new URL('src/fonts/fonts.css', document.baseURI).href}');`;
