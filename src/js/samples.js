...
const SAMPLE = {
  'vocab-grid':{'template':'vocab-grid','lang':'de','level':'B1','topic':'Die Wohnung','topicMeaning':'Căn nhà','items':[
  ...
  'sentence-pairs':{'template':'sentence-pairs','lang':'en','topic':'Phrasal Verbs','level':'B1','title':'Office English','items':[
  ...
  'conjugation':{'template':'conjugation','lang':'fr','tense':"Présent de l'indicatif",'note':"Avoir & être dùng để tạo thì phức passé composé.",'verbs':[
  ...
  'idiom-spotlight':{'template':'idiom-spotlight','lang':'en','topic':'Idioms & Phrasal Verbs','items':[
  ...
  'dialogue':{'template':'dialogue','lang':'en','scene':'At the Café','level':'A2','speakers':{A:{name:'Staff',color:'#0284c7'},B:{name:'Customer',color:'#16a34a'}},'lines':[
  ...
  'word-map':{'template':'word-map','lang':'de','topic':'REISEN','topicMeaning':'đi du lịch','groups':[
  ...
  'word-family':{'template':'word-family','lang':'de','base_word':'lernen','word_type':'Verb','meaning':'học','topic':'Giao tiếp và ngôn ngữ','level_range':'A1-C1','combinations':[
